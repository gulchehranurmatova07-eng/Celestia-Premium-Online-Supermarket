...
const PRODUCTS: SeedProduct[] = [
  ...
  { sku: "CEL-1106", name: "Баранина", brand: "Мясная лавка", category: "gosht", weight: "1 кг", price: 110000, image: "/products/qoy-goshti-real.webp", stock: 0, rating: 4.5, ratingCount: 22, description: "Молодая баранина для шашлыка и национальных блюд.", ingredients: "100% баранина.", nutrition: "Энергетическая ценность: 294 ккал/100г, белки: 25г.", daysAgo: 20 },
  ...
  { sku: "CEL-1108", name: "Куриное бедро", brand: "Птицефабрика", category: "tovuq", weight: "1 кг", price: 32000, image: "/products/tovuq-son-real.webp", stock: 4, rating: 4.4, ratingCount: 54, description: "Сочное куриное бедро.", ingredients: "100% куриное мясо.", nutrition: "Энергетическая ценность: 209 ккал/100г, белки: 26г.", daysAgo: 9 },
  ...
  { sku: "CEL-1120", name: "Средство для мытья посуды Fairy", brand: "Fairy", category: "maishiy", weight: "500 мл", price: 22000, image: "/products/fairy-idish-real.webp", stock: 39, rating: 4.7, ratingCount: 165, description: "Концентрированное средство, эффективно растворяет жир.", ingredients: "5-15% анионные ПАВ, консерванты, отдушка.", nutrition: "Не является пищевым продуктом.", daysAgo: 3 },
