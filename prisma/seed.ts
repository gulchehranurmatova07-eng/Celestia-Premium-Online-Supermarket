...
const PRODUCTS: SeedProduct[] = [
  ...
  { sku: "CEL-1134", name: "Кофе Nescafe Gold", brand: "Nescafe", category: "oziq-ovqat", weight: "250 г", price: 53000, image: "/products/nescafe-gold.webp", stock: 36, rating: 4.7, ratingCount: 145, description: "Oʻzbekcha: Nescafe Gold kofe. Растворимый кофе, созданный с арабикой.", ingredients: "100% растворимый кофе.", nutrition: "Энергетическая ценность: 3 ккал/100мл (напиток).", daysAgo: 5 },
